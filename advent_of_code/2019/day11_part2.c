...
static void print_map(char map[MAP_SIZE][MAP_SIZE], int x, int y, int robot_dir);
...
static void print_map(char map[MAP_SIZE][MAP_SIZE], int robot_x, int robot_y, int robot_dir)
{
