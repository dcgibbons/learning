...
' --------+------------+-----------------------------------------------
'    4.00 | 2004-04-30 | Updated for change request # 23 (no changes).
' --------+------------+-----------------------------------------------
...
Public Class Mortgage
    ...
    '
    Private theInterestRate As Decimal

    '
    ' The MonthlyRate of the mortgage (as opposed to the yearly rate).
    '
    Private theMonthlyRate As Decimal
    ...
    ' and mortgage term.
    '
    Public Sub New(ByVal principal As Decimal, ByVal rate As Decimal, ByVal term As Integer)
