 ...
 *   3.00  | 2006-01-28 | Added default constructor so creating mortgage terms
 *                      | alone is easier. TODO: perhaps a MortgageTerms object?
 *   4.00  | 2006-02-03 | Merged Week 4 and Week 5 assignments into an Applet
...
public class Mortgage implements Cloneable {
     ...
     */
    public Mortgage(final double rate, final int term) {
        setPrincipal(0.0);
        setRate(rate);
        setTerm(term);
    }
    ...
    public String toString() {
        final String fmt = "{0,number,#.000 %} for {1,number,integer} Years";
