...
/**
 * This class subclasses the {@link JTable} class and provides useful utility
...
public class JTableHelper extends JTable {
     ...
     *
     * @param tm the table model to use when creating the parent {@link JTable}
     */
    ...
    public void limitTableViewport(final int rows,
        ...
        if (spaceForVerticalScrollBar) {
            ...
            extraWidth = sbPreferredSize.width;
        }
        ...
        if (spaceForHorizontalScrollBar) {
            ...
            extraHeight = sbPreferredSize.height;
        }
    ...
    /**
     * When a {@link JTable} has focus it automatically processes certain
